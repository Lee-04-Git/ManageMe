  ...
  return (
    <div className="mb-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        {/* New Project Card */}
        <div className="bg-[#2a2d35] rounded-2xl p-5">
          ...
          <div className="mb-3">
            <div className="flex items-center gap-1 mb-2">
              <div className="flex -space-x-2">
                <div className="w-6 h-6 rounded-full border-2 border-[#2a2d35] overflow-hidden">
          ...
          <div className="flex justify-between">
            <div className="flex -space-x-1">
              <div className="w-4 h-4 rounded-full border border-[#2a2d35] overflow-hidden">
