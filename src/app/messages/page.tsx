  ...
  const messages = [
    {
      ...
      content: "Hey! I've reviewed the project timeline and it looks great. When can we start implementing phase 2?",
      time: "10:30 AM",
      isOwn: false
    },
    {
      id: 2,
      sender: "You",
      content: "Thanks Alex! We can start phase 2 next Monday. I'll send you the detailed breakdown by end of day.",
      time: "10:32 AM",
      isOwn: true
    },
    {
            ...
            {conversations.map((conversation) => (
              <div
                ...
                className={`flex items-center p-4 rounded-lg mb-2 cursor-pointer transition-colors ${
                  conversation.id === 1 ? 'bg-[#ff6b6b]/10 border border-[#ff6b6b]/20' : 'hover:bg-[#2a2d35]'
                }`}
              >
              ...
              {messages.map((message) => (
                ...
                >
                  ...
                  >
                    ...
                    <p className={`text-xs mt-1 ${message.isOwn ? 'text-red-100' : 'text-gray-400'}`}>
                      {message.time}
                    </p>
                  </div>
                </div>
