...
import { Star, ThumbsUp, MessageCircle, Filter, Search, MoreVertical } from "lucide-react"
  ...
  const reviews = [
    {
      ...
      rating: 5,
      review: "Exceptional work! The team delivered beyond our expectations. The platform is fast, secure, and user-friendly. Highly recommend for any web development projects.",
      date: "Oct 20, 2024",
      avatar: "TC",
      helpful: 12,
      verified: true
    },
    {
      ...
      rating: 4,
      review: "Great experience working with this team. Professional, timely, and the final product exceeded our requirements. Minor issues with initial communication but overall fantastic.",
      date: "Oct 18, 2024",
      avatar: "SX",
      helpful: 8,
      verified: true
    },
    {
      ...
      rating: 5,
      review: "Outstanding quality and attention to detail. The dashboard is intuitive and powerful. The team was responsive and implemented all our feedback perfectly.",
      date: "Oct 15, 2024",
      avatar: "IT",
      helpful: 15,
      verified: true
    },
    {
      ...
      rating: 4,
      review: "Solid work on the analytics platform. The AI integration works seamlessly and the insights are valuable. Would work with them again for future projects.",
      date: "Oct 12, 2024",
      avatar: "DF",
      helpful: 6,
      verified: false
    },
    {
      ...
      rating: 5,
      review: "Incredible team! They transformed our vision into reality. The app is beautiful, fast, and our users love it. Communication was excellent throughout the project.",
      date: "Oct 10, 2024",
      avatar: "GC",
      helpful: 20,
      verified: true
    },
    {
      ...
      rating: 4,
      review: "Professional team with great technical skills. The LMS is feature-rich and meets all our educational requirements. Delivery was on time and within budget.",
      date: "Oct 8, 2024",
      avatar: "ES",
      helpful: 9,
      verified: true
      ...
      <main className="flex-1 p-8 overflow-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-[#2a2d35] p-6 rounded-lg">
            <h3 className="text-gray-400 text-sm font-medium mb-2">Total Reviews</h3>
            <p className="text-3xl font-bold text-white">{stats.totalReviews}</p>
          </div>
          <div className="bg-[#2a2d35] p-6 rounded-lg">
            <h3 className="text-gray-400 text-sm font-medium mb-2">Average Rating</h3>
          ...
          <div className="bg-[#2a2d35] p-6 rounded-lg">
            <h3 className="text-gray-400 text-sm font-medium mb-2">5-Star Reviews</h3>
            <p className="text-3xl font-bold text-green-400">{stats.fiveStars}</p>
          </div>
          <div className="bg-[#2a2d35] p-6 rounded-lg">
            <h3 className="text-gray-400 text-sm font-medium mb-2">Verified Reviews</h3>
            <p className="text-3xl font-bold text-blue-400">{reviews.filter(r => r.verified).length}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-[#2a2d35] p-6 rounded-lg">
              <h3 className="text-white font-semibold text-lg mb-4">Rating Breakdown</h3>
                ...
                <div key={review.id} className="bg-[#2a2d35] p-6 rounded-lg">
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          <h3 className="text-white font-semibold">{review.client}</h3>
                          {review.verified && (
