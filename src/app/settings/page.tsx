...
import { Settings, Bell, Shield, Palette, Globe, Database, Moon, Sun } from "lucide-react"
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Get instant notifications in browser</p>
                </div>
                <input type="checkbox" className="toggle" defaultChecked />
              </div>
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Notifications from team members</p>
                </div>
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Direct messages from clients</p>
                </div>
                <input type="checkbox" className="toggle" defaultChecked />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="w-full bg-gray-700 rounded-full h-2">
                  <div className="bg-[#ff6b6b] h-2 rounded-full" style={{ width: '48%' }}></div>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Automatically backup project data</p>
                </div>
                <input type="checkbox" className="toggle" defaultChecked />
              </div>
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Free up space by clearing cache</p>
                </div>
                <button className="bg-[#1a1d23] text-gray-300 px-4 py-2 rounded-lg text-sm border border-gray-600">
                  Clear
                </button>
